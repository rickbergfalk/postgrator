...
module.exports = function (config) {
    ...
    if (config.driver == 'mysql') {
        ...
        commonClient.queries.makeTable = "CREATE TABLE schemaversion (version INT, name TEXT DEFAULT '', md5 TEXT DEFAULT ''); INSERT INTO schemaversion (version, name, md5) VALUES (0, '', '');";
        ...
        commonClient.queries.makeTable = "CREATE TABLE schemaversion (id INT IDENTITY(1, 1) PRIMARY KEY, version INT); INSERT INTO schemaversion (version) VALUES (0);";

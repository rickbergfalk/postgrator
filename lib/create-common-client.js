...
module.exports = function (config) {
    ...
    if (config.driver == 'mysql') {
        ...
        console.log("currenversion", commonClient.queries.getCurrentVersion);
        console.log("checktable", commonClient.queries.checkTable);
        console.log("maketable", commonClient.queries.makeTable);
